...
const mastersService = {
    ...
    updateZone: (id, data) => client.put(`/masters/zones/${id}/`, data),
    ...
    updateCircle: (id, data) => client.put(`/masters/circles/${id}/`, data),
    ...
    updateDivision: (id, data) => client.put(`/masters/divisions/${id}/`, data),
    ...
    updateSubDivision: (id, data) => client.put(`/masters/subdivisions/${id}/`, data),
    ...
    updateDistrict: (id, data) => client.put(`/masters/districts/${id}/`, data),
    ...
    updateTown: (id, data) => client.put(`/masters/towns/${id}/`, data),
    ...
    updateSchemeType: (id, data) => client.put(`/masters/scheme-types/${id}/`, data),
    ...
    updateScheme: (id, data) => client.put(`/masters/schemes/${id}/`, data),
    ...
    updateWorkType: (id, data) => client.put(`/masters/work-types/${id}/`, data),
    ...
    updateContractor: (id, data) => client.put(`/masters/contractors/${id}/`, data),
    ...
    updateETPCharge: (id, data) => client.put(`/masters/etp-charges/${id}/`, data),
