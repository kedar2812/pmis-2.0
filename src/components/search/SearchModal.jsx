    ...
    return (
        ...
        >
            ...
            >
                ...
                {showFilters && (
                    <motion.div
                        className="px-4 py-3 border-b border-slate-200/60 bg-slate-50/50"
                            ...
                            <div className="space-y-1">
                                {recentSearches.slice(0, 5).map((term, index) => (
                                    <button
                                        ...
                                        className="flex items-center gap-3 w-full px-3 py-2 rounded-lg hover:bg-slate-100 transition-colors text-left group"
                                    >
                                ...
                                {NAVIGATION_PAGES.slice(0, 8).map((page) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-slate-100 transition-colors text-left group"
                                        >
                        ...
                        <div className="py-2">
                            {Object.entries(groupedResults).map(([category, items]) => (
                                <div key={category} className="mb-4">
                                    <h3 className="px-4 py-2 text-xs font-semibold text-slate-500 uppercase tracking-wide bg-slate-50/50">
