...
export const AnimatedBarChart = ({ data, dataKey, height = 300, color = '#10b981', name }: AnimatedBarChartProps) => {
...
export const AnimatedLineChart = ({ data, dataKey, height = 300, color = '#8b5cf6', name }: AnimatedLineChartProps) => {
  // Use stable ID for gradients
  const id = useId();
