                ...
                <div className="p-4 bg-slate-50 border-b border-slate-200">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm text-slate-600 line-clamp-2">{boqItem.description}</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-4">
                        <div className="flex justify-between text-xs mb-1">
                            <span className="text-slate-600">Allocated to Milestones</span>
                        ...
                        <div className="space-y-4">
                                ...
                                <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-3">
                                    ...
                                    <div className="flex gap-2">
                                        <select
                                            ...
                                            className="flex-1 px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 bg-white"
                                        >
                                        ...
                                        <div className="relative w-24">
                                            <input
                                                ...
                                                className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 pr-7"
                                            />
                            ...
                            {remaining <= 0 && (
                                <div className="p-4 bg-green-50 border border-green-200 rounded-lg flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-green-800">Fully Allocated</p>
                                        <p className="text-xs text-green-600">This BOQ item is 100% linked to milestones</p>
                                    </div>
                                </div>
                            )}
                            ...
                            {milestones.length === 0 && (
                                <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-amber-800">No Milestones Found</p>
